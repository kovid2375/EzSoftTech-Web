      ...
      >
        ...
        >
          ...
          <div className="flex flex-col gap-4 relative z-10 max-w-xl">
            ...
            <div>
              <h3 className="text-2xl font-bold text-neutral-900 group-hover:text-emerald-600 transition-colors duration-300 mb-2">
          ...
          <div className="relative mt-8 w-full flex justify-center transition-transform duration-500 group-hover:scale-[1.02] z-10">
            <div className="relative w-full max-w-[420px] h-[250px] border border-neutral-200/80 bg-neutral-50 rounded-2xl shadow-lg overflow-hidden flex flex-col p-4">
              <div className="flex justify-between items-start border-b border-neutral-200/80 pb-3">
                <div>
                  <h4 className="text-xs font-bold text-neutral-900">EZ SOFT TECH PVT. LTD.</h4>
                  <p className="text-[10px] text-neutral-400">GSTIN: 22AAAAA0000A1Z5</p>
                </div>
                <div className="text-right">
                  <span className="text-[10px] bg-emerald-100 text-emerald-700 font-bold px-2.5 py-0.5 rounded-full inline-block">PAID</span>
                  <p className="text-[10px] text-neutral-500 mt-1 font-mono">INV-2026-0839</p>
                </div>
              </div>
              <div className="flex-1 py-3 flex flex-col justify-between">
                <table className="w-full text-left text-[11px] font-medium text-neutral-600">
                  <thead>
                    <tr className="border-b border-neutral-100 text-[10px] text-neutral-400 font-mono">
                  ...
                  <tbody>
                    <tr className="border-b border-neutral-100/50">
                      <td className="py-1.5 font-semibold text-neutral-800">Business Automation Engine</td>
                      <td className="py-1.5 text-center">1</td>
                      <td className="py-1.5 text-right">$1,299.00</td>
                      <td className="py-1.5 text-right">18%</td>
                    </tr>
                    <tr>
                      <td className="py-1.5 font-semibold text-neutral-800">Local POS Client License</td>
                      <td className="py-1.5 text-center">2</td>
                      <td className="py-1.5 text-right">$399.00</td>
                      <td className="py-1.5 text-right">18%</td>
                    </tr>
                  </tbody>
                </table>
                <div className="border-t border-neutral-200/80 pt-3 flex justify-between items-center text-xs font-bold text-neutral-900">
        ...
        >
          <div className="flex flex-col gap-4">
            ...
            <div>
              <h3 className="text-xl font-bold text-neutral-900 group-hover:text-blue-600 transition-colors duration-300 mb-2">
        ...
        >
          ...
          <div className="relative my-8 flex flex-col items-center justify-center z-10 py-4">
            <div className="flex flex-col gap-4 w-full max-w-[240px] text-xs font-mono">
              <div className="bg-neutral-800 border border-neutral-700/60 rounded-xl p-3 flex items-center gap-3">
                <div className="w-2.5 h-2.5 rounded-full bg-emerald-400 animate-pulse" />
                <div className="flex-1">
                  <p className="text-[10px] text-neutral-400 uppercase font-semibold">Step 1: Event Trigger</p>
              ...
              <div className="bg-neutral-800 border border-neutral-700/60 rounded-xl p-3 flex items-center gap-3">
                ...
                <div className="flex-1">
                  <p className="text-[10px] text-neutral-400 uppercase font-semibold">Step 2: Generation</p>
                  <p className="text-white font-medium">Render PDF Invoice</p>
                </div>
              </div>
              ...
              <div className="bg-neutral-800 border border-neutral-700/60 rounded-xl p-3 flex items-center gap-3">
                ...
                <div className="flex-1">
                  <p className="text-[10px] text-neutral-400 uppercase font-semibold">Step 3: Alert & Sync</p>
                  <p className="text-white font-medium">WhatsApp Notification</p>
                </div>
              </div>
            </div>
          </div>
