            ...
            <div className="flex flex-col lg:flex-row items-center lg:items-start gap-10 lg:gap-16">
                <div className="flex flex-col gap-6 w-full lg:w-1/2">
                    ...
                    <p className="text-base sm:text-lg text-neutral-600 leading-relaxed">
                        At EZGlobal, <span className="text-blue-600 font-bold">we design and build intelligent billing software and custom business automation solutions.</span> We empower retail establishments, wholesale distributors, e-commerce giants, and service enterprises to streamline their daily operations, remove manual bottlenecks, and secure transactions with cutting-edge technology. From GST-compliant invoicing to real-time supply chain tracking, we create high-performance systems tailored to your workflows.
                    </p>
                    <p className="text-base sm:text-lg text-neutral-600 leading-relaxed">
