            ...
            {filteredTechnologies.map((tech) => {
              ...
              return (
                ...
                >
                  ...
                  <div>
                    <h3 className="font-bold text-neutral-800 text-sm sm:text-base mb-1">{tech.name}</h3>
                    <p className="text-[11px] text-neutral-400 font-semibold tracking-wider uppercase">{tech.category}</p>
                  </div>
                </motion.div>
              )
            })}
