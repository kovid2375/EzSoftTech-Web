...
export function Section1(){
    ...
    return(
        <main className="p-3">
            <div 
                className="relative w-full rounded-3xl overflow-hidden flex flex-col pt-16 pb-6 md:pt-24 md:pb-8 shadow-xl bg-[#faf9f7] bg-cover bg-center"
            ...
            >
                ...
                <div className="absolute right-[10%] top-[5%] opacity-80 hidden lg:flex flex-col items-center select-none pointer-events-none text-neutral-800 z-10">
                ...
                <div className="absolute right-[15%] top-[30%] opacity-80 hidden xl:flex flex-col items-center select-none pointer-events-none text-neutral-800 z-10">
                ...
                <div className="absolute left-[10%] top-[10%] opacity-80 hidden lg:flex flex-row items-center select-none pointer-events-none text-amber-500 z-10">
                    <motion.div
                ...
                <div className="relative z-10 flex flex-col items-center justify-center">
                    <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-[70px] text-neutral-900 font-bold font-plus-jakarta leading-tight text-center items-center">
                        Smarter strategy.
                    </h1>
                    <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-[70px] text-neutral-900 font-bold font-plus-jakarta leading-tight mt-1 text-center items-center">
                        <span className="text-[#0b64f1]">Powered By AI</span>
                    </h1>

                    <div className="mt-4 flex flex-col text-neutral-600 text-sm sm:text-base md:text-lg font-medium tracking-wide max-w-2xl space-y-1">
                ...
                {/* Premium Browser Mockup Wrapper for Video */}
                <div className="relative z-10 w-full max-w-5xl mx-auto mt-12 px-6 sm:px-12">
