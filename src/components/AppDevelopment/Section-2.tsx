      ...
      >
        ...
        >
          ...
          <div className="relative mt-8 w-full flex justify-center transition-transform duration-500 group-hover:scale-[1.02] z-10">
            <div className="relative w-56 h-[320px] border-[6px] border-neutral-800 bg-neutral-950 rounded-[32px] shadow-lg overflow-hidden flex flex-col">
              {/* Notch */}
              <div className="absolute top-0 inset-x-0 h-3 bg-neutral-800 flex justify-center items-center z-20">
                <div className="w-14 h-1.5 bg-neutral-950 rounded-full" />
              </div>
              <div className="relative w-full h-full overflow-hidden bg-neutral-900 pt-2.5">
                <img 
          ...
          <div className="relative my-8 flex flex-col items-center justify-center z-10 py-4">
            <div className="relative w-36 h-36 flex items-center justify-center">
              ...
              <div className="absolute inset-4 rounded-full bg-neutral-950 border-2 border-emerald-500 flex flex-col items-center justify-center shadow-[0_0_30px_rgba(16,185,129,0.25)]">
                <span className="text-4xl font-extrabold tracking-tight text-emerald-400">120</span>
                <span className="text-[10px] font-bold text-emerald-500 uppercase tracking-widest mt-0.5">FPS TARGET</span>
              </div>
            </div>
