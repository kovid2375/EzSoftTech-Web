...
interface TechItem {
  name: string
  category: 'Frameworks' | 'Backend' | 'Databases' | 'DevOps'
...
const categories = ['All', 'Frameworks', 'Backend', 'Databases', 'DevOps']
    ...
    <section className="py-24 px-4 relative overflow-hidden font-sans">
      ...
      <div className="max-w-7xl mx-auto text-center mb-16 relative z-10">
        ...
        <p className="text-base sm:text-lg text-neutral-600 max-w-2xl mx-auto leading-relaxed">
          We use state-of-the-art frameworks, cross-platform compilation engines, and DevOps pipelines to build flawless mobile products.
        </p>
      </div>
