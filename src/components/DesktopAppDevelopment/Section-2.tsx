      ...
      >
        ...
        >
          ...
          <div className="relative mt-8 w-full flex justify-center transition-transform duration-500 group-hover:scale-[1.02] z-10">
            <div className="relative w-full max-w-[450px] h-[250px] border border-neutral-200/80 bg-neutral-50 rounded-2xl shadow-lg overflow-hidden flex flex-col">
              {/* Title bar */}
              <div className="h-10 bg-neutral-100 border-b border-neutral-200/80 px-4 flex items-center justify-between">
                <div className="flex gap-2">
                  <span className="w-3 h-3 rounded-full bg-red-400" />
                  <span className="w-3 h-3 rounded-full bg-yellow-400" />
                  <span className="w-3 h-3 rounded-full bg-green-400" />
                </div>
                <span className="text-xs font-medium text-neutral-500 font-mono">dashboard_app.exe</span>
                <div className="w-12" /> {/* Spacer */}
              </div>
              {/* Window Workspace */}
              <div className="flex-1 flex bg-white">
                {/* Sidebar */}
                <div className="w-1/4 border-r border-neutral-200 bg-neutral-50/50 p-3 flex flex-col gap-2">
                ...
                <div className="flex-1 p-4 flex flex-col gap-3">
                  <div className="flex gap-3">
                    <div className="h-12 bg-blue-50 border border-blue-100 rounded-lg flex-1 p-2 flex flex-col justify-between">
                      <span className="text-[10px] text-blue-500 font-semibold font-mono">CPU USAGE</span>
                      <span className="text-xs font-bold text-neutral-800">1.2%</span>
                    </div>
                    <div className="h-12 bg-emerald-50 border border-emerald-100 rounded-lg flex-1 p-2 flex flex-col justify-between">
                      <span className="text-[10px] text-emerald-500 font-semibold font-mono">FPS TARGET</span>
                      <span className="text-xs font-bold text-neutral-800">120 FPS</span>
                    </div>
                  </div>
        ...
        >
          <div className="flex flex-col gap-4">
            ...
            <div>
              <h3 className="text-xl font-bold text-neutral-900 group-hover:text-orange-600 transition-colors duration-300 mb-2">
          ...
          <div className="relative my-8 flex flex-col items-center justify-center z-10 py-4">
            <div className="relative w-36 h-36 flex items-center justify-center">
              ...
              <div className="absolute inset-4 rounded-full bg-neutral-950 border-2 border-emerald-500 flex flex-col items-center justify-center shadow-[0_0_30px_rgba(16,185,129,0.25)]">
                <span className="text-3xl font-extrabold tracking-tight text-emerald-400">0%</span>
                <span className="text-[10px] font-bold text-emerald-500 uppercase tracking-widest mt-0.5">LAG TARGET</span>
              </div>
            </div>
