  ...
  return (
    <section className="py-24 px-4 relative overflow-hidden font-sans">
      ...
      <div className="max-w-7xl mx-auto text-center mb-16 relative z-10">
        <div className="inline-flex items-center gap-2 mb-4 text-xs md:text-sm font-semibold tracking-[0.2em] text-[#d97706] uppercase">
      ...
      >
        ...
        >
          ...
          <div className="flex flex-col gap-4 relative z-10 max-w-xl">
            ...
            <div>
              <h3 className="text-2xl font-bold text-neutral-900 group-hover:text-amber-600 transition-colors duration-300 mb-2">
          ...
          <div className="relative mt-8 w-full flex justify-center transition-transform duration-500 group-hover:scale-[1.02] z-10">
            <div className="relative w-full max-w-[420px] h-[250px] border border-neutral-200/80 bg-neutral-50 rounded-2xl shadow-lg overflow-hidden flex flex-col p-4 gap-4">
              <div className="flex justify-between items-center">
                <div className="flex items-center gap-2">
                  <div className="w-2.5 h-2.5 rounded-full bg-amber-500 animate-pulse" />
                  <span className="text-xs font-bold text-neutral-700">Search Console Audit</span>
                </div>
                <span className="text-[10px] text-neutral-400 font-mono">Real-time Stats</span>
              </div>
              
              <div className="flex gap-4">
                <div className="flex-1 bg-white border border-neutral-200/60 rounded-xl p-3 flex flex-col justify-between">
                  <span className="text-[10px] text-neutral-400 font-semibold font-mono">ORGANIC CLICKS</span>
                  <div className="flex items-baseline gap-1 mt-1">
                    <span className="text-base font-bold text-neutral-800">42.8K</span>
                    <span className="text-[9px] text-emerald-500 font-bold">+24%</span>
                  </div>
                </div>
                <div className="flex-1 bg-white border border-neutral-200/60 rounded-xl p-3 flex flex-col justify-between">
                  <span className="text-[10px] text-neutral-400 font-semibold font-mono">SITE HEALTH</span>
                  <div className="flex items-baseline gap-1 mt-1">
                    <span className="text-base font-bold text-neutral-800">98 / 100</span>
              ...
              <div className="flex-1 bg-white border border-neutral-200/60 rounded-xl p-3 flex flex-col justify-between">
                ...
                <div className="flex flex-col gap-1.5 text-[11px] text-neutral-600">
                  <div className="flex justify-between">
                    <span className="font-medium text-neutral-800">best software company bilaspur</span>
                  ...
                  <div className="flex justify-between border-t border-neutral-100/50 pt-1.5">
                    <span className="font-medium text-neutral-800">gst billing software chhattisgarh</span>
                    <span className="font-mono text-emerald-600 font-bold">#1</span>
                  </div>
                </div>
              </div>
        ...
        >
          ...
          <div className="relative my-8 flex flex-col items-center justify-center z-10 py-4">
            <div className="relative w-36 h-36 flex items-center justify-center">
              ...
              <div className="absolute inset-4 rounded-full bg-neutral-950 border-2 border-amber-500 flex flex-col items-center justify-center shadow-[0_0_30px_rgba(245,158,11,0.25)]">
                <span className="text-3xl font-extrabold tracking-tight text-amber-400">5.2x</span>
                <span className="text-[9px] font-bold text-amber-500 uppercase tracking-widest mt-0.5">ROAS TARGET</span>
              </div>
            </div>
            
            {/* Ad stats table */}
            <div className="grid grid-cols-2 gap-x-6 gap-y-2 mt-8 w-full max-w-[200px] text-xs font-mono">
