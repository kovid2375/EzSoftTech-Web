            ...
            <div className="flex flex-col lg:flex-row items-center lg:items-start gap-10 lg:gap-16">
                <div className="flex flex-col gap-6 w-full lg:w-1/2">
                    ...
                    <p className="text-base sm:text-lg text-neutral-600 leading-relaxed">
                        At EZGlobal, we deliver data-driven digital marketing solutions designed to expand your brand's presence, capture high-intent leads, and accelerate conversions. <span className='text-blue-600 font-bold'>By aligning Search Engine Optimization (SEO), Pay-Per-Click (PPC) advertising, content strategy, and Social Media Marketing (SMM), we position your business directly in front of your ideal clients.</span> Whether you are aiming to dominate the local Raipur market or reach a global audience, our campaigns are built to scale.
                    </p>
                    <p className="text-base sm:text-lg text-neutral-600 leading-relaxed">
